<!-- Pegando o css de produtos, como estava na programação estruturada -->
<link rel="stylesheet" href="/css/produtos.css" rel="stylesheet"/>

<?php   //Esse $data é da função view(), que está em Core/Controller.php 
